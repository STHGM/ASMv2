...
public class cadForFis extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel15.setText("Cadastro de Fornecedor Físico");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Todos os campos devem ser preenchidos", "Cadastro de Fornecedor Físico", JOptionPane.ERROR_MESSAGE);
            c = 2;
        }
        if (c != 2) {
                ...
                try {
                    ...
                    if (n > 0) {
                        ...
                        try {
                            ...
                            if (n2 > 0) {
                                JOptionPane.showMessageDialog(null, "Dados salvos com sucesso", "Cadastro de Fornecedor Físico", JOptionPane.INFORMATION_MESSAGE);
                                int op = JOptionPane.showConfirmDialog(null, "Deseja cadastrar outro fornecedor agora?", "Cadastro de Fornecedor Físico", JOptionPane.YES_NO_OPTION);
                                if (op == 0) {
                                    cond = true;
                                    dispose();
                                    new cadForFis().setVisible(true);
