...
public class cadFor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Tipo de Fornecedor:");
        jLabel16.setToolTipText("");

        cx_tipo.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        cx_tipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "------", "Físico", "Jurídico" }));
      ...
      MyConnection mc = new MyConnection();
        ...
        try {
            if (cx_nome.getText().equals("") || cx_tipo.getSelectedItem().toString().equals("------") || cx_endereco.getText().equals("") || cx_bairro.getText().equals("") || cx_cidade.getText().equals("") || cx_cep.getText().equals("") || cx_telefone1.getText().equals("") || cx_telefone2.getText().equals("") || cx_email.getText().equals("") || cx_estado.getSelectedItem().toString().equals("------")) {
                throw new Exception();
            } else if (cx_tipo.getSelectedItem().toString().equals("Jurídico")) {
            ...
            } else if(cx_tipo.getSelectedItem().toString().equals("Físico")){
            ...
            JOptionPane.showMessageDialog(null, "Todos os campos devem ser preenchidos", "Cadastro de Fornecedor", JOptionPane.ERROR_MESSAGE);
            c = 2;
        }
        if (c != 2 && tipo==1) {
    ...
    private void cx_tipoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cx_tipoActionPerformed
        if(evt.getSource() == cx_tipo){
            ...
            switch(msg){
                case "Físico": label_cpf_cnpj.setText("CPF");
                    //JFormattedTextField field = new JFormattedTextField();
                    //{
                        try {
                            cx_cpf_cnpj.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("###.###.###-##")));
                        } catch (ParseException ex) {
                            Logger.getLogger(cadFor.class.getName()).log(Level.SEVERE, null, ex);
                        }
                    //}
                    break;
                case "Jurídico": label_cpf_cnpj.setText("C.N.P.J.");
                    //{
                        try {
                            cx_cpf_cnpj.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##.###.###/####-##")));
                        } catch (ParseException ex) {
